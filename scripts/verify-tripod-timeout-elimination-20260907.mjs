...
const checks = [
  ...
  ["site-context fetch lets the server finish its 15s Overpass fallback", client.includes('const SITE_CONTEXT_FETCH_ATTEMPT_TIMEOUT_MS = 18_000') && client.includes('}, SITE_CONTEXT_FETCH_ATTEMPT_TIMEOUT_MS);')],
