...
assert.match(viewer,/GOOGLE_PHOTOREALISTIC_ION_ASSET_ID\s*=\s*2275207/u);
assert.match(viewer,/Cesium3DTileset\.fromUrl\(rootResource/u);
assert.match(viewer,/geocoder:\s*IonGeocodeProviderType\.GOOGLE/u);
