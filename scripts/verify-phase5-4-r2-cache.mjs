...
const files = ["timezone.ts", "geocode.ts", "gsi-elevation.ts", "osm-site-context.ts"].map((name) => read(`functions/api/${name}`));
...
const checks = [
  ...
  [cache.includes("bucket.delete(key)"), "invalid entry removal"],
